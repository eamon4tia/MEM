...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def onRunBtnClick(self):
        ...
        xls_file = read_excel(self.ui.excelFileName)
        ...
        for i in range(0, n_rows):
            ...
            insert_query = "INSERT INTO Subscribers (WorkId,Name,TotalCost ) VALUES ('{}', '{}','{}')"
            self.cursor.execute(insert_query)

        self.db.commit()
        self.ui.runBtn.setEnabled(False)
        self.ui.excelLabel.setText("Successful")
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
       ...
       # gridLayout.addWidget(pushButton1, 0, 1, 1, 1)
        ...
        self.sqlFileName = "C:\\Users\\PC WORLD\\Downloads\\test.sqlite"
